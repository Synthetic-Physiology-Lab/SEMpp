...
proc ::TopoTools::readvarxyz_mod  {filename {flags none}} {
...
# 	$sel set user2 [lindex $aname]	
    }
    mol reanalyze $mol

#set Max_type_Part [llength $maxcount]
#for {set i 0} {$i < $Max_type_Part} {incr i} {      #typecount is the number of names
#set sel [atomselect top "name $i"]
#$sel set user2 [lindex $typemap $i]
#echo $i
#}
